defmodule ExMpesa.TransactionStatusTest do
  @moduledoc false

  use ExUnit.Case, async: true

  import Tesla.Mock
  doctest ExMpesa.TransactionStatus

  alias ExMpesa.TransactionStatus
  ...
  setup do
    mock(fn
      ...
      %{
        url: "https://sandbox.safaricom.co.ke/mpesa/transactionstatus/v2/query",
        method: :post
      } ->
        %Tesla.Env{
          status: 200,

defmodule ExMpesa.B2B do
  ...
  ## Example
      iex> ExMpesa.B2B.request(%{command_id: "BusinessPayBill", amount: 10500, receiver_party: 600000, remarks: "B2B Request", account_reference: "BILL PAYMENT"})
      {:ok,
        %{
  ...
  defp b2b_request(
    ...
    payload = %{
      "Initiator" => Application.get_env(:ex_mpesa, :b2b)[:initiator_name],
      "SecurityCredential" => security_credential,
      "CommandID" => command_id,
      "Amount" => amount,
      "PartyA" => Application.get_env(:ex_mpesa, :b2b)[:short_code],
      "SenderIdentifierType" => 4,
      "PartyB" => receiver_party,
      "RecieverIdentifierType" => 4,
      "Remarks" => remarks,
      "AccountReference" => account_reference,
      "QueueTimeOutURL" => Application.get_env(:ex_mpesa, :b2b)[:timeout_url],

defmodule ExMpesa.B2C do
  ...
  defp b2c_request(
    ...
    result_url = Map.get(params, :result_url, Application.get_env(:ex_mpesa, :b2c)[:result_url])

    payload = %{
      "InitiatorName" => Application.get_env(:ex_mpesa, :b2c)[:initiator_name],
      "SecurityCredential" => security_credential,
      "CommandID" => command_id,
      "Amount" => amount,
      "PartyA" => Application.get_env(:ex_mpesa, :b2c)[:short_code],
      "PartyB" => phone_number,
      "Remarks" => remarks,
      "QueueTimeOutURL" => Application.get_env(:ex_mpesa, :b2c)[:timeout_url],
